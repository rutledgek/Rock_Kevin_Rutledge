...
namespace online.kevinrutledge.InvoiceSystem.Migrations
{
	...
	ALTER TABLE [dbo].[_online_kevinrutledge_InvoiceSystem_InvoiceType] CHECK CONSTRAINT [FK__online_kevinrutledge_InvoiceSystem_InvoiceType_ModifiedByPersonAliasId]");
            ...
            RockMigrationHelper.UpdateEntityType("online.kevinrutledge.InvoiceSystem.Model.InvoiceType", online.kevinrutledge.InvoiceSystem.SystemGuids.EntityGuids.Invoice_Type, true, true);
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteEntityType(online.kevinrutledge.InvoiceSystem.SystemGuids.EntityGuids.Invoice_Type);
        }
    }
}