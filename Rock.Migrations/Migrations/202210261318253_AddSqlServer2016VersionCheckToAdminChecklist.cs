...
namespace Rock.Migrations
{
    ...
    public partial class AddSqlServer2016VersionCheckToAdminChecklist : Rock.Migrations.RockMigration
    {
        ...
        public override void Up()
        {
            ...
            if ( !is2016OrHigher )
            {
                RockMigrationHelper.UpdateDefinedValue( Rock.SystemGuid.DefinedType.ADMINISTRATOR_CHECKLIST, "Upgrade to SQL Server 2016 or Later", "Please remember that starting with v15 Rock will no longer support SQL Server 2014 (see this link<https://community.rockrms.com/connect/ending-support-for-sql-server-2014> for more details).", "6538909A-B75E-46C3-A141-3CA02DD6DE06" );
            }
        }
        ...
        public static bool CheckSqlServerVersionGreaterThanSqlServer2016()
        {
            ...
            try
            {
                var sqlVersion = DbService.ExecuteScaler( "SELECT SERVERPROPERTY('productversion')" ).ToString();
