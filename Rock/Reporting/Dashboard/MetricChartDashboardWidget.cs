...
namespace Rock.Reporting.Dashboard
{
    ...
    {
        /// <summary>
        /// Attribute keys used to identify block configuration settings.
        /// </summary>
        protected static class AttributeKeys
        {
            /// <summary>
            /// The selected partition filter values.
            /// </summary>
            public const string MetricEntityTypeEntityIds = "MetricEntityTypeEntityIds";
            /// <summary>
            /// The Detail Page that is shown when the chart is clicked.
            /// </summary>
        ...
        /// <summary>
        /// Gets a flag indicating if the current block has additional properties that can be modified.
        /// </summary>
        ...
        /// <summary>
        /// Gets the partition value filters specified by the current block configuration.
        /// These filters are applied to limit the range of metric values displayed in the chart.
        /// </summary>
        /// <returns></returns>
        ...
        public void LoadChart()
        {
            ...
            rockChart.Title = this.Title;
            rockChart.Subtitle = this.Subtitle;
            rockChart.ShowTooltip = true;
            rockChart.ShowLegend = this.ShowLegend;
            rockChart.LegendPosition = this.LegendPosition;
        ...
        /// </summary>
        protected abstract void OnLoadChart();
