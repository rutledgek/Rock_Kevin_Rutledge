    ...
    public class ReminderTypeFieldType : FieldType, IEntityFieldType, IEntityReferenceFieldType
    {
        ...
        List<ReferencedEntity> IEntityReferenceFieldType.GetReferencedEntities( string privateValue, Dictionary<string, string> privateConfigurationValues )
        {
            ...
            using ( var rockContext = new RockContext() )
            {
                ...
                {
                    new ReferencedEntity( EntityTypeCache.GetId<ReminderType>().Value, reminderTypeId.Value )
                };
            }
        }
        ...
        List<ReferencedProperty> IEntityReferenceFieldType.GetReferencedProperties( Dictionary<string, string> privateConfigurationValues )
        {
            ...
            {
                new ReferencedProperty( EntityTypeCache.GetId<ReminderType>().Value, nameof( ReminderType.Name ) )
            };
        }
        ...
        public override string GetEditValue( Control control, Dictionary<string, ConfigurationValue> configurationValues )
        {
            ...
            if ( picker != null )
            {
                // picker has value as ReminderType.Guid
