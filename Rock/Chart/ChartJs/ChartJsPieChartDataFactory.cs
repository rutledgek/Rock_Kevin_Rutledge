...
namespace Rock.Chart
{
    ...
    /// For time series data, the pie chart shows aggregate values divided into equal time periods.
    /// </summary>
    /// <remarks>
    ...
    public class ChartJsPieChartDataFactory : ChartJsDataFactory
    {
        ...
        private string GetChartDataJsonInternal( dynamic chartData, ChartJsonArgs args )
        {
            ...
            this.ApplyChartStyleToArgs( args );
            ...
            var optionsLegend = this.GetLegendConfigurationObject( args.DisplayLegend, legendPosition, args.LegendAlignment );
