...
";
            ...
            processINSERTScript += GetPersonPropertiesSelectSQLScript( propertyColumns );
...
WHERE p.Id NOT IN (
        ...
        /// <param name="propertyColumns">The person property columns.</param>
        /// <returns></returns>
        private static string GetPersonPropertiesSelectSQLScript( List<ColumnInfo> propertyColumns )
        {
            string selectSQL = @"
    SELECT 
        p.Id [PersonId],
