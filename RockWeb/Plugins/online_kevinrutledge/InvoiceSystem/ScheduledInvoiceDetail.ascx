<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScheduledInvoiceDetail.ascx.cs"
    Inherits="RockWeb.Plugins.online_kevinrutledge.InvoiceSystem.ScheduledInvoiceDetail" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                <h1 class="panel-title">Schedule Information</h1>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <Rock:RockControlWrapper ID="rcwSchedule" runat="server" Label="Schedule" Help="Select the schedule of when the metric values should be calculated.">
                                                    ...
                                                    <Rock:SchedulePicker ID="spSchedulePicker" runat="server" Label="Named Schedule" Visible="false" />

                                                    <asp:HiddenField ID="hfUniqueScheduleId" runat="server" />
                                                    <Rock:ScheduleBuilder ID="sbSchedule" runat="server" ShowDuration="false" ShowScheduleFriendlyTextAsToolTip="true" Visible="false" OnSaveSchedule="sbSchedule_SaveSchedule" />
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <Rock:NumberBox ID="numbSendInvoiceDays" runat="server"
                                                    Default="5"
                                                    Label="How Many Days Before the Due Date Should the Invoice Be Sent?"
                                                    Help="This is the number of days before the Due Date the invoice should be sent. If 0 is used, the invoice will be sent on the due date in the schedule." />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <Rock:NumberBox ID="numbLateDays" runat="server"
                                                    Default="5"
                                                    Label="How Many Days After the Due Date is the Invoice Late?"
                                                    Help="This is the number of days after the Due Date the invoice should be considered late. This will be used when creating the invoices from the schedule." />
                                            </div>
                                        </div>
                                    </div>
                                </div>
