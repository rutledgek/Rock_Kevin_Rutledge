                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-9  alert alert-success">
                                    <p>To set a default late fee for invoices of this type enter a Late Fee Amount for a
                                        flat fee or a Late Fee Percent for a fee based on the total amount.</p>
                                    <br />
                                    <div class="col-md-6">
                                        <Rock:CurrencyBox ID="numbLateFeeAmount" runat="server" Label="Late Fee Amount"
                                            Help="The amount that should be added to the invoice once it is considered late."
                                            Placeholder="0.00" />
                                    </div>
                                    <div class="col-md-6">
                                        <Rock:NumberBox ID="numbLateFeePercent" runat="server" Label="Late Fee Percent"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class=" alert alert-success">
                                        ...
                                        <hr />
                                        <Rock:DataTextBox ID="tbInvoiceSubject"
                                            runat="server"
                                            SourceTypeName="online.kevinrutledge.InvoiceSystem.Model.InvoiceType, online.kevinrutledge.InvoiceSystem"
                                ...
                                <div class="col-md-6">
                                    <div class="alert alert-warning">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3>Late Notice Communications</h3>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <hr />
                                        <Rock:DataTextBox ID="tbLateNoticeSubject"
                                            runat="server"
                                            SourceTypeName="online.kevinrutledge.InvoiceSystem.Model.InvoiceType, online.kevinrutledge.InvoiceSystem"
