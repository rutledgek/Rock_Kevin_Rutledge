                ...
                <div id="invoiceSettings" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <Rock:RangeSlider ID="rsSendInvoiceDaysBefore" runat="server"
                                    Label="Default Send Invoice Days Before Due" MaxValue="31" MinValue="0" StepValue="1"
                                    SelectedValue="0"
                                    Help="This the number of days before the invoice due date to send the invoice." />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class=" panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <p>
                                            Select a system communication to use or enter your own communication
                                                template.
                                        </p>
