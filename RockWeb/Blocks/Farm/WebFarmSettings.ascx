                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-9">
                            ...
                            <Rock:NumberBox ID="nbPollingDifference" runat="server" AppendText="seconds" Label="Min Interval Difference" Help="When starting, nodes may choose a random polling interval between the min and max. This value is the minimum difference between nodes' selected intervals. For example, if one node is polling every 300 seconds, and this value is 10, then another node may poll at 290 or 310, but not any closer. If this value is left blank, then a default will be used." />
                        </div>
                        <div class="col-md-6 col-sm-9">
