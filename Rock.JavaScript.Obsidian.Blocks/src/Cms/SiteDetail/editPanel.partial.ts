...
export default defineComponent({
    ...
    emits: {
        "update:modelValue": (_value: SiteBag) => true,
    ...
    setup(props, { emit }) {
        ...
        const attributes = ref(props.modelValue.attributes ?? null);
        const attributeValues = ref(props.modelValue.attributeValues ?? null);
        ...
        watch(() => props.modelValue, () => {
            updateRefValue(attributes, props.modelValue.attributes ?? null);
            updateRefValue(attributeValues, props.modelValue.attributeValues ?? null);
